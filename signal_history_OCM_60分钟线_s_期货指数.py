...
if __name__ == '__main__':
    ...
    N1_lst = [30, 40, 50, 60, 70]  # 短周期周期1
    N2_lst = [280, 320, 360, 400, 440]  # 长周期周期2

    K1_lst = [s / 100 for s in range(5, 96, 10)]  # 近期比例
    K2_lst = [s / 100 for s in range(5, 96, 10)]  # 长期比例
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_ocmup_' + str(x) + str(n) + 's.csv')
