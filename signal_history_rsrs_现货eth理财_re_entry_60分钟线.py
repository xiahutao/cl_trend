...
if __name__ == '__main__':
    ...
    period_k1_lst = [i for i in range(21, 22, 1)]  # N1 计算线性回归的K值
    period_std1_lst = [i for i in range(55, 56, 5)]  # N2 计算斜率标准化的周期
    N_l_lst = [i/10 for i in range(21, 22)]  # 多头开仓阈值

    win_stop_lst = [10000]
    status_days_lst = [0]

    P_ATR_LST = [28, 32, 36, 40, 24, 20, 12, 16]  # ATR周期
    ATR_n_lst = [0.8, 0.7, 0.6, 0.5, 0.9, 1.0, 1.1,1.2, 1.3, 1.4, 1.5, 1.6]  # ATR倍数
