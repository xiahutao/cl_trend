...
if __name__ == '__main__':
    ...
    n = 60  # 回测周期
    period = '60m'
    road_period_l_lst = [i for i in range(15, 16, 1)]  # 通道周期
    K1_lst = [i/100 for i in range(70, 71, 5)]  # 浮动倍数
    N1_lst = [10]  # 均线周期
    P_ATR_LST = [18, 22, 26, 30, 34, 38, 42, 14, 10]  # ATR周期
    ATR_n_lst = [2, 2.1, 2.2, 2.3]  # ATR倍数
    status_days_lst = [0]
                ...
                for road_period_l in road_period_l_lst:
                    ...
                    for K1 in K1_lst:
                        ...
                        for (s_date, e_date) in date_lst:
                            ...
                            if len(group_) < 20:
                                continue
                            # group_.to_csv('cl_trend/data/group.csv')
                            ...
                            for ATR_n in ATR_n_lst:
                                for status_day in status_days_lst:
                                    ...
                                    #                        })
                                    # net_df.to_csv('cl_trend/data/data/spot_010_' + period + '_' + symble + '.csv')
                                    ...
                                    # signal_state.to_csv('cl_trend/data/signal_010_' + period + '_' + symble + '.csv')
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_dt_eth_' + str(n) + '.csv')
