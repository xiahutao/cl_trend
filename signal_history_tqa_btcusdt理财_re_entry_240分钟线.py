...
if __name__ == '__main__':
    ...
    road_period_l_lst = [8]  # 唐奇安通道周期
    road_period_s_lst = [7]  # 唐奇安通道周期
    ma_period_lst = [15]
    P_ATR_LST = [20]  # ATR周期
    ATR_n_lst = [0.5]  # ATR倍数
    status_days_lst = [i for i in range(0, 50, 1)]
    win_stop_lst = [0.15]
                            ...
                            for ATR_n in ATR_n_lst:
                                for win_stop in win_stop_lst:
                                    for status_day in status_days_lst:
                                        ...
                                        # signal_state.to_csv('cl_trend/data/signal_tqa_' + str(status_day) + '_' + symble + '_' + back_stime + 'ls.cs
