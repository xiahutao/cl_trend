...
if __name__ == '__main__':
    ...
    ma_lst = [i for i in range(7, 15)]  # 统计周期
    k_lst = [i/100 for i in range(20, 81, 5)]  # 阈值
    p_lst = [i/100 for i in range(20, 60, 5)]  # 阈值
    win_stop_lst = [10]
    P_ATR_LST = [36, 32, 28, 24, 20, 16, 12]  # ATR周期
    ATR_n_lst = [1000000, 1.0, 1.1, 1.2, 0.9, 0.8, 1.3, 1.4, 1.5, 1.6, 1.7, 1.8, 1.9]  # ATR倍数
    status_days_lst = [0]
