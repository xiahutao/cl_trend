...
if __name__ == '__main__':
    ...
    # symble = 'yeeeth'
    x = 8
    symble_lst = ['xrpbtc', 'etcbtc', 'ethbtc', 'trxbtc', 'neobtc', 'adabtc', 'ontbtc']
    n = 60  # 回测周期
    period = '60m'

    road_period_l_lst = [55]  # 唐奇安通道周期
    ma_period_lst = [10]
    P_ATR_LST = [24]  # ATR周期
    ATR_n_lst = [0.6]  # ATR倍数
    # status_days_lst = [0]
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_tqa_btc_entry' + str(n) + '.csv')
