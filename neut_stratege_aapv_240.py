...
if __name__ == '__main__':
    ...
    ma_lst = [i for i in range(11, 12)]  # 统计周期
    k_lst = [i / 100 for i in range(70, 71, 5)]  # 阈值
    p_lst = [i / 100 for i in range(65, 66, 5)]  # 阈值

    P_ATR_LST = [20, 24, 28, 32, 36, 40]  # ATR周期
    ATR_n_lst = [0.6, 0.7, 0.8, 0.9, 1.0, 100000]  # ATR倍数
    status_days_lst = [0]
    win_stop_lst = [10]
