...
if __name__ == '__main__':
    ...
    N1_lst = [i for i in range(4, 5, 1)]  # 短周期周期1
    N2_lst = [i for i in range(20, 21, 2)]  # 长周期周期2

    K1_lst = [i/100 for i in range(60, 61, 5)]  # 近期比
    K2_lst = [i/100 for i in range(20, 21, 5)]  # 长期比例
