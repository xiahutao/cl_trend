...
if __name__ == '__main__':
    ...
    N3_lst = [45]  # 短周期周期1
    N4_lst = [60]  # 长周期周期2
    K1_lst = [i / 100 for i in range(55, 66, 5)]  # 近期比
    K2_lst = [i / 100 for i in range(5, 16, 5)]  # 长期比例
    K3_lst = [i / 100 for i in range(65, 76, 5)]  # 近期比例
    K4_lst = [i / 100 for i in range(5, 16, 5)]  # 长期比例
    P_ATR_LST = [20]  # ATR周期
    ATR_n_lst = [0.5]  # ATR倍数
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_ocm_reverse_' + str(n) + 'ls.csv')
