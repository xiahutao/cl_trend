        ...
        for min_n in min_n_lst:
            ...
            for loss_stop in loss_stop_lst:
                for win_stop in win_stop_lst:
                    ...
                    net_df.to_csv('cl_trend/data/net_'+str(x)+'.csv')
                    x+=1
