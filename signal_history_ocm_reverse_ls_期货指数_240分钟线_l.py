...
if __name__ == '__main__':
    ...
    N1_lst = [i for i in range(15, 25, 1)]  # 短周期周期1
    N2_lst = [i for i in range(20, 26, 1)]  # 长周期周期2

    K1_lst = [i / 100 for i in range(10, 96, 5)]  # 近期比
    K2_lst = [i / 100 for i in range(10, 96, 5)]  # 长期比例
