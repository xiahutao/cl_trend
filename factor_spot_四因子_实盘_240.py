...
if __name__ == '__main__':
    ...
    date_lst = [('2018-01-01', '2019-12-01')]
    trade_lst = ['ethbtc', 'xrpbtc', 'ltcbtc', 'eosbtc', 'bchabcbtc', 'bnbbtc', 'trxbtc', 'adabtc',
                 'ontbtc', 'etcbtc']
    ...
    name_lst = ['ethbtc', 'eosbtc', 'etcbtc', 'iotabtc', 'iostbtc', 'ltcbtc', 'neobtc', 'trxbtc', 'xrpbtc', 'xlmbtc',
                'adabtc', 'ontbtc', 'bnbbtc', 'bchabcbtc', "mdabtc", "stratbtc", "xmrbtc", "dashbtc",
                "xembtc", "zecbtc", "wavesbtc", "btgbtc", "vetbtc", "qtumbtc", "omgbtc", "zrxbtc", "gvtbtc"]

    # name_lst = ['ethbtc', 'eosbtc']
    factor_lst_all = ["Alpha.alpha046", "Alpha.alpha049", "Alpha.alpha052", "Alpha.alpha071", "Alpha.alpha082",
                      "Alpha.alpha093", "Alpha.alpha096", "Alpha.alpha112", "Alpha.alpha128", "Alpha.alpha129",
                      "Alpha.alpha133"]  # 正向因子
    ...
    for factor_1 in factor_lst_all:
        for factor_2 in factor_lst_all:
            for factor_3 in factor_lst_all:
                for factor_4 in factor_lst_all:
                    if (factor_1 < factor_2) & (factor_3 > factor_2) & (factor_3 < factor_4):
                        factor_row = []
                        factor_row.append(factor_1)
                        factor_row.append(factor_2)
                        factor_row.append(factor_3)
                        factor_row.append(factor_4)
                        factor_lst_.append(factor_row)
    factor_lst_ = [["Alpha.alpha018", "Alpha.alpha050", "Alpha.alpha052", "Alpha.alpha055", "Alpha.alpha060", "Alpha.alpha069", "Alpha.alpha071"],
                   ["Alpha.alpha003", "Alpha.alpha014", "Alpha.alpha050", "Alpha.alpha051", "Alpha.alpha069",
                    "Alpha.alpha128", "Alpha.alpha167", "Alpha.alpha175"],
                   ["Alpha.alpha096", "Alpha.alpha112", "Alpha.alpha133", "Alpha.alpha052", "Alpha.alpha071",
                    "Alpha.alpha128"],
                   ["Alpha.alpha082", "Alpha.alpha049", "Alpha.alpha129", "Alpha.alpha093", "Alpha.alpha153",
                    "Alpha.alpha046", "Alpha.alpha189"],
                   ["Alpha.alpha049", "Alpha.alpha052", "Alpha.alpha096", "Alpha.alpha133"],
                   ["Alpha.alpha071", "Alpha.alpha082", "Alpha.alpha112", "Alpha.alpha128"],
                   ["Alpha.alpha049", "Alpha.alpha128", "Alpha.alpha129", "Alpha.alpha133"],
                   ["Alpha.alpha049", "Alpha.alpha096", "Alpha.alpha112", "Alpha.alpha128"]
                   ]
        ...
        for loss_stop in loss_stop_lst:
            for win_stop in win_stop_lst:
                ...
                for (s_date, e_date) in date_lst:
                    ...
                    net_df_[['date_time', 'net']]\
                        .assign(net=lambda df: df.net/df.net.tolist()[0])\
                        .to_csv('cl_trend/data/data/5'+str(i)+'_'+period+'.csv')
    ...
    res.to_csv('cl_trend/data/alpha_3_' + str(n) + '.csv')
