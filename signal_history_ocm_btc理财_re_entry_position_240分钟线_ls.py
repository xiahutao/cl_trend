...
if __name__ == '__main__':
    ...
    date_lst = [('2018-01-01', '2019-04-20')]
    df_lst = []
    lst = []
    state_lst = []
                            ...
                            for N4 in N4_lst:
                                ...
                                if (N1 < N2) & (N3 < N4):
                                    ...
                                    for (s_date, e_date) in date_lst:
                                        ...
                                        print(group_)
                                        # group_.to_csv('cl_trend/data/ocm_signal_' + symble + '_' + period + '.csv')
                                                                ...
                                                                for status_day in status_days_lst:
                                                                    for cut_position in cut_position_lst:
                                                                        ...
                                                                        if (symble == 'ethindex') | (symble == 'eosbtc'):
                                                                            ...
                                                                            net_df.to_csv(
                                                                                'cl_trend/data/data/future_003_' + period + '_ethusd.csv')
                                                                            ...
                                                                            net_df.to_csv(
                                                                                'cl_trend/data/data/future_003_' + period + '_xbtusd.csv')
                                                                            ann_ROR = annROR(net_lst, n)
                                                                            total_ret = net_lst[-1]
                                                                            max_retrace = maxRetrace(net_lst, n)
                                                                            sharp = yearsharpRatio(net_lst, n)
