...
if __name__ == '__main__':
                                ...
                                for N_s in N_s_lst:
                                    ...
                                    for idx, _row in group_.iterrows():
                                        if position == 0:
                                            ...
                                            elif (_row.rsrs0 < N_s) & (_row.c_ma < 0) & (_row.ma_zd < 0):
                                                cost = _row.close
                                                position = -1
                                                s_time = _row.date_time
                                                value_start = value
    ...
    res = pd.DataFrame(state_lst,
                   columns=['period', 'win_r', 'odds', 'total_ret', 'ann_ret',
                            'sharp', 'max_retrace', 'trade_times'
                       , 'ave_r', 'ave_hold_days', 'win_r_3', 'win_r_5', 'ave_max',
                            'win_r_3_p', 'win_r_5_p',
                            'ave_max_p', 'art_N', 'art_n', 'period_k0',
                            'period_std0', 'period_k1', 'period_std1',
                            'n_l', 'n_s', 'ma_period', 'back_stime', 'back_etime'])
    res.to_csv('cl_trend/data/neu_strategy_RSRS_' + str(n) + '1.csv')