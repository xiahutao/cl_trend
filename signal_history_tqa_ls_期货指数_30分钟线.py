...
if __name__ == '__main__':
    ...
    road_period_l_lst = [i for i in range(36, 45, 2)]  # 唐奇安通道周期
    road_period_s_lst = [i for i in range(36, 45, 2)]  # 唐奇安通道周期
    ma_period_lst = [20, 15]
    P_ATR_LST = [14, 16, 20, 22]  # ATR周期
    ATR_n_lst = [0.5, 0.6, 0.7]  # ATR倍数
