...
if __name__ == '__main__':
    ...
    n = 240  # 回测周期
    period = '240m'
    N3_lst = [i for i in range(5, 6, 1)]  # 短周期周期1
    N4_lst = [i for i in range(8, 9, 1)]  # 长周期周期2

    K3_lst = [i / 100 for i in range(70, 71, 5)]  # 近期比
    K4_lst = [i / 100 for i in range(35, 36, 5)]  # 长期比例
    P_ATR_LST = [20]  # ATR周期
    ATR_n_lst = [0.5]  # ATR倍数
    win_stop_lst = [10]
    status_days_lst = [0]
