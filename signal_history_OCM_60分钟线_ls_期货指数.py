...
if __name__ == '__main__':
    ...
    K3_lst = [0.95]  # 近期比例
    K4_lst = [0.15]  # 长期比例
    P_ATR_LST = [12, 14, 16, 18, 20, 22, 24, 26]  # ATR周期
    ATR_n_lst = [0.5, 0.6, 0.7, 0.8, 0.9]  # ATR倍数

    lever_lst = [1]  # 杠杆率，btc初始仓位pos=1,usdt初始仓位pos=0;做多情况下，btc仓位1+lever,usdt仓位-lever;
    # 做空情况下，btc仓位1-lever,usdt仓位lever

    fee = 0.001
    date_lst = [('2017-01-01', '2018-12-01'), ('2017-01-01', '2017-10-01'), ('2017-10-01', '2018-01-01'), ('2018-01-01', '2018-12-01')]
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_ocmup_' + str(n) + 'ls1.csv')
