...
if __name__ == '__main__':
    ...
    N1_lst = [i for i in range(26, 27)]  # 短周期
    N2_lst = [i for i in range(65, 66, 1)]  # 中周期
    N3_lst = [i for i in range(100, 101, 1)]  # 长周期
    N4_lst = [i for i in range(120, 121)]  # 唐奇安通道数
                    ...
                    for N4 in N4_lst:
                        ...
                        for ATR_n in ATR_n_lst:
                            ...
                            for idx, _row in group_.iterrows():
                                if position == 0:
                                    if (_row.ma1 > _row.ma2) & (_row.close_1 > _row.ma3) & (_row.close > _row.hhv):
                                        cost = _row.close
                                        position = 1
                                    ...
                                    elif (_row.ma1 < _row.ma2) & (_row.close_1 < _row.ma3) & (_row.close < _row.llv):
                                        cost = _row.close
                                        position = -1
                                        s_time = _row.date_time
                                        value_start = value
