...
if __name__ == '__main__':
    ...
    N1_lst = [i / 100 for i in range(80, 105, 100)]  # 下阈值
    N2_lst = [i / 100 for i in range(102, 140, 100)]  # 上阈值

    N_lst = [i for i in range(3, 4)]
    ...
    for N in N_lst:
        ...
        group_ = df_btc_.merge(df_eth_, on=['tickid']).sort_values(['tickid']) \
            .assign(apha_ratio=lambda df: df.factor_e / df.factor_b) \
...
res.to_csv('cl_trend/data/neu_strategy_factor47_' + str(n) + '1.csv')
