...
if __name__ == '__main__':
    ...
    N3_lst = [i for i in range(4, 7, 1)]  # 短周期周期1
    N4_lst = [i for i in range(7, 13, 1)]  # 长周期周期2

    K3_lst = [i / 100 for i in range(10, 96, 5)]  # 近期比
    K4_lst = [i / 100 for i in range(10, 96, 5)]  # 长期比例
    P_ATR_LST = [20]  # ATR周期
    ATR_n_lst = [0.5]  # ATR倍数
