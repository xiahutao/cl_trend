...
if __name__ == '__main__':
    ...
    # symble = 'yeeeth'
    x = 8
    symble_lst = ['btcindex', 'ethindex']
    n = 60  # 回测周期
    period = '60m'
    period_k0_lst = [65]  # N1 计算线性回归的K值
    period_std0_lst = [150]  # N2 计算斜率标准化的周期
    period_k1_lst = [22]  # N1 计算线性回归的K值
    period_std1_lst = [260]  # N2 计算斜率标准化的周期
    N_l_lst = [0.9]  # 多头开仓阈值
    N_s_lst = [-0.7]  # 空头开仓阈值
    win_stop_lst = [10]
    status_days_lst = [0]
    ...
    # date_lst = [('2019-01-01', '2019-10-02')]
    df_lst = []
    lst = []
    state_lst = []
                    ...
                    for period_k1 in period_k1_lst:
                        ...
                        for period_std1 in period_std1_lst:
                            ...
                            for (s_date, e_date) in date_lst:
                                ...
                                group_.to_csv('cl_trend/data/rsrs_signal_' + symble + '_' + period + '.csv')
                                            ...
                                            for win_stop in win_stop_lst:
                                                for status_day in status_days_lst:
                                                    if (symble == 'ethindex') | (symble == 'eosbtc'):
                                                        ...
                                                        signal_state.to_csv('cl_trend/data/signal_rsrs_' + str(n) + '_' + symble + '.csv')
                                                        ...
                                                        signal_state.to_csv('cl_trend/data/signal_rsrs_' + str(
                                                            n) + '_' + symble + '.csv')
                                                        # df_lst.append(signal_state)
    ...
    signal_state = pd.DataFrame(state_lst, columns=['symble', 'tm', 'win_r', 'odds', 'total_ret', 'ann_ret', 'sharp',
                                                    ...
                                                    'period_k1', 'period_std1', 'N_l', 'N_s', 'win_stop', 'status_day',
                                                    's_time', 'e_time'])
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_rsrs_btc_re_entry_' + str(n) + 'ls1.csv')
