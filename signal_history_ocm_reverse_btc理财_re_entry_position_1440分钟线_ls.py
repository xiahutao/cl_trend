...
if __name__ == '__main__':
                            ...
                            for N4 in N4_lst:
                                ...
                                if (N1 < N2) & (N3 < N4):
                                    ...
                                    for (s_date, e_date) in date_lst:
                                        ...
                                        # group_.to_csv('cl_trend/data/ocm_reverse_signal_' + symble + '_' + period + '.csv')
                                        print(group_)
                                                                ...
                                                                for status_day in status_days_lst:
                                                                    for cut_position in cut_position_lst:
                                                                        ...
                                                                        if (symble == 'ethindex') | (symble == 'eosbtc'):
                                                                                ...
                                                                                if pos == 0:
                                                                                    ...
                                                                                    if pos > 0:
                                                                                        if (_row.long_ratio0 > K4) & (
                                                                                                    (_row.low - _row.LL_s0) < (_row.HH_s0 - _row.LL_s0) * (0.5 - 0.5 * K3)):

                                                                                            s_price = ((0.5 - 0.5 * K3) * (_row.HH_s0 - _row.LL_s0) + _row.LL_s0) * (1 - fee)
                                                                                            if _row.open < (0.5 - 0.5 * K3) * (
                                                                                                    _row.HH_s0 - _row.LL_s0) + _row.LL_s0:
                                                                            ...
                                                                            net_df.to_csv(
                                                                                'cl_trend/data/data/future_006_' + period + '_ethusd.csv')
                                                                            ...
                                                                            signal_state.to_csv('cl_trend/data/signal_ocm_reverse_' + str(n) + '_' + symble + '.csv')
                                                                            ...
                                                                            net_df.to_csv(
                                                                                'cl_trend/data/data/future_006_' + period + '_xbtusd.csv')
                                                                            # net_df[['date_time', 'net', 'close']].plot(
                                                                            #     x='date_time', kind='line', grid=True,
                                                                            #     title=symble + '_' + period)
                                                                            #
                                                                            ...
                                                                            signal_state.to_csv(
                                                                                'cl_trend/data/signal_ocm_reverse_' + str(
                                                                                    n) + '_' + symble + '.csv')
                                                                            # df_lst.append(signal_state)
                                                                            win_r, odds, ave_r, mid_r = get_winR_odds(signal_state.ret.tolist())
                                                                            win_R_3, win_R_5, ave_max = get_winR_max(signal_state.max_ret.tolist())
    ...
    print(signal_state)
    # signal_state.to_csv('cl_trend/data/state_ocm_reverse_btc_entry_position_' + str(n) + 'ls.csv')
