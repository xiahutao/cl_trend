...
if __name__ == '__main__':
    ...
    n = 60  # 回测周期
    period = '60m'
    N3_lst = [i for i in range(20, 25, 1)]  # 短周期周期1
    N4_lst = [i for i in range(28, 33, 1)]  # 长周期周期2

    K3_lst = [i / 100 for i in range(55, 66, 5)]  # 近期比
    K4_lst = [i / 100 for i in range(25, 36, 5)]  # 长期比例
    P_ATR_LST = [20]  # ATR周期
    ATR_n_lst = [0.5]  # ATR倍数
    win_stop_lst = [10]
    status_days_lst = [0]
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_ocm_reverse_btc_entry_' + str(n) + 's.csv')
