...
if __name__ == '__main__':
    ...
    road_period_l_lst = [15]  # 通道周期
    road_period_s_lst = [i for i in range(18, 25, 1)]
    K1_lst = [0.45]  # 浮动倍数
    K2_lst = [i/100 for i in range(35, 56, 5)]  # 浮动倍数
    N1_lst = [15]  # 均线周期
    win_stop_lst = [10]
    P_ATR_LST = [20]  # ATR周期
    ATR_n_lst = [0.5]  # ATR倍数
        ...
        for N_ATR in P_ATR_LST:
            ...
            for N1 in N1_lst:
                ...
                for road_period_s in road_period_s_lst:
                    ...
                    for K2 in K2_lst:
                        group__ = day_atr.assign(sellRange_1=lambda df: df.open - K2 * df.max_HCL_s.shift(1))
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_dt_btc' + str(n) + 's.csv')
