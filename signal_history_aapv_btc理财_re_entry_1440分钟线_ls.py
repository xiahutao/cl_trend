...
if __name__ == '__main__':
    ...
    ma_lst = [i for i in range(12, 13)]  # 统计周期
    k_lst = [i/100 for i in range(45, 46, 2)]  # 阈值
    p_lst = [i/100 for i in range(42, 43, 2)]  # 阈值
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_aapv_' + str(n) + 'ls.csv')
