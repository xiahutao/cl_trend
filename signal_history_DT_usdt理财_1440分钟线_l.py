...
if __name__ == '__main__':
    ...
    K1_lst = [i / 100 for i in range(40, 91, 5)]  # 浮动倍数
        ...
        for N_ATR in P_ATR_LST:
            ...
            for N1 in N1_lst:
                ...
                for road_period in road_period_lst:
                    ...
                    for K1 in K1_lst:
                        group__ = day_atr.assign(buyRange_1=lambda df: K1 * df.max_HCL.shift(1) + df.open)
    ...
    signal_state = pd.DataFrame(state_lst, columns=['symble', 'tm', 'win_r', 'odds', 'total_ret', 'ann_ret', 'sharp',
                                                    ...
                                                    'K1', 'N1', 's_time', 'e_time'])
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_dt_btcusdt_' + str(n) + 'l.csv')
