...
if __name__ == '__main__':
    ...
    N1_lst = [25, 30, 35]  # 短周期周期1
    N2_lst = [170, 180, 190]  # 长周期周期2

    K1_lst = [s / 100 for s in range(60, 71, 5)]  # 近期比例
    K2_lst = [s / 100 for s in range(50, 61, 5)]  # 长期比例
    P_ATR_LST = [20]  # ATR周期
    ATR_n_lst = [0.5]  # ATR倍数
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_ocm_btcusdt_' + str(n) + 'l.csv')
