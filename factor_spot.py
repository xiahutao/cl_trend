...
if __name__ == '__main__':
    ...
    period = '1440m'
    n = 1440
    min_n_lst = [i for i in range(1, 9)]
    loss_stop_lst = [1]
    win_stop_lst = [100000]
    fee = 0.002
    date_lst = [('2017-10-01', '2019-04-01'), ('2017-10-01', '2018-01-01'), ('2018-01-01', '2018-07-01'),
                ('2018-07-01', '2019-12-01')]
    # trade_lst = ['ethbtc', 'xrpbtc', 'ltcbtc', 'eosbtc', 'bchabcbtc', 'bchsvbtc', 'bnbbtc', 'xlmbtc', 'trxbtc', 'adabtc',
    #              'xmrbtc', 'dashbtc', 'ontbtc', 'etcbtc', 'neobtc', 'omgbtc']
    ...
    pre_data_df = pd.read_csv('data/coinbase_btc_28_predata' + period + '.csv')
    ...
    res.to_csv('cl_trend/data/neu_alpha001_' + str(n) + '.csv')
