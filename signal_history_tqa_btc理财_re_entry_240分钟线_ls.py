...
if __name__ == '__main__':
    ...
    road_period_l_lst = [5]  # 唐奇安通道周期
    road_period_s_lst = [4]  # 唐奇安通道周期
    ma_period_lst = [20]
    P_ATR_LST = [16]  # ATR周期
    ATR_n_lst = [0.6]  # ATR倍数
    # status_days_lst = [0]
    status_days_lst = [109, 42]
    win_stop_lst = [0.2]

    lever = 1  # 杠杆率，btc初始仓位pos=1,usdt初始仓位pos=0;做多情况下，btc仓位1+lever,usdt仓位-lever;
    # 做空情况下，btc仓位1-lever,usdt仓位lever
    fee = 0.003
    date_lst = [('2017-01-01', '2018-01-01'), ('2018-01-01', '2018-06-01'), ('2018-06-01', '2018-12-30')]
    # date_lst = [('2017-01-01', '2018-12-30')]
    df_lst = []
    lst = []
    state_lst = []
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_tqa_usdt_entry' + str(n) + 'ls.csv')
