...
if __name__ == '__main__':
    ...
    N1_lst = [i for i in range(3, 7)]  # 计数阈值
    N2_lst = [i for i in range(3, 10, 2)]  # 统计周期
    N3_lst = [i for i in range(4, 15, 2)]  # 计数上限

    N4_lst = [i for i in range(2, 5)]  # 计数阈值
    N5_lst = [i for i in range(3, 7)]  # 统计周期
    N6_lst = [i for i in range(3, 7)]  # 计数上限
    win_stop_lst = [10]
    status_days_lst = [0]
    P_ATR_LST = [30]  # ATR周期
