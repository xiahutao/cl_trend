...
if __name__ == '__main__':
    ...
    N1_lst = [i for i in range(7, 8)]  # 短周期
    N2_lst = [i for i in range(16, 17, 1)]  # 中周期
    N3_lst = [i for i in range(35, 36, 1)]  # 长周期
    N4_lst = [i for i in range(30, 31)]  # 唐奇安通道数
    P_ATR_LST = [34]  # ATR周期
    ...
    res.to_csv('cl_trend/data/neu_strategy_tld_' + str(n) + '1.csv')