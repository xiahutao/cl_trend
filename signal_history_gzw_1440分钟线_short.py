                                        ...
                                        for lever in lever_lst:
                                            if len(group):
                                                ...
                                                if len(day_atr) > max(N1, N2, N3):
                                                    ...
                                                    hhv_num_list = []
                                                    llv_num_list = []
                                                    for idx, irow in group__.iterrows():
                                                    ...
                                                    group__ = group__.assign(hhv_num=hhv_num_list) \
                                                    ...
                                                    for (s_date, e_date) in date_lst:
                                                        group_ = group__[(group__['date_time'] >= s_date) & (
                                                                group__['date_time'] <= e_date)].reset_index(drop=True)
