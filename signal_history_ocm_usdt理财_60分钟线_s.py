...
if __name__ == '__main__':
    ...
    N3_lst = [35, 40, 45]  # 短周期周期1
    N4_lst = [110, 120, 130]  # 长周期周期2

    K3_lst = [s / 100 for s in range(90, 101, 5)]  # 近期比例
    K4_lst = [s / 100 for s in range(10, 21, 5)]  # 长期比例
    P_ATR_LST = [20]  # ATR周期
    ATR_n_lst = [0.5]  # ATR倍数
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_ocm_btcusdt_' + str(n) + 's.csv')
