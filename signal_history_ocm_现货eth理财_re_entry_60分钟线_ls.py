...
if __name__ == '__main__':
    ...
    N1_lst = [i for i in range(18, 19, 3)]  # 短周期周期1
    N2_lst = [i for i in range(65, 66, 5)]  # 长周期周期2

    K1_lst = [i/100 for i in range(65, 66, 5)]  # 近期比
    K2_lst = [i/100 for i in range(70, 71, 5)]  # 长期比例

    P_ATR_LST = [20, 24, 28, 32, 36, 40, 12, 16]  # ATR周期
    ATR_n_lst = [0.6, 0.7, 0.8, 0.9, 1, 1.1, 1.2, 1.3, 1.4, 1.5, 1.6, 1.7]  # ATR倍数
