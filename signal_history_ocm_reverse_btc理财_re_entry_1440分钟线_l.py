...
if __name__ == '__main__':
    ...
    N1_lst = [i for i in range(4, 10)]  # 短周期周期1
    N2_lst = [i for i in range(13, 18)]  # 长周期周期2

    K1_lst = [i/100 for i in range(20, 71, 5)]  # 近期比
    K2_lst = [i/100 for i in range(10, 81, 5)]  # 长期比例
