...
if __name__ == '__main__':
    ...
    symble_lst = ['ethbtc', 'eosbtc', 'etcbtc', 'iotabtc', 'iostbtc', 'ltcbtc', 'neobtc', 'trxbtc', 'xrpbtc',
                  'xlmbtc', 'adabtc', 'ontbtc', 'tusdbtc', 'bnbbtc', 'bchabcbtc', 'bchsvbtc', 'bchbtc']
    symble_lst = ['xrpbtc', 'etcbtc', 'ethbtc','iotabtc','adabtc']
    n = 60  # 回测周期
    period = '60m'
    ...
    lever = 1
    fee = 0.0036
    # date_lst = [('2017-01-01', '2018-01-01'), ('2018-01-01', '2018-07-01'), ('2018-07-01', '2019-02-01')]
