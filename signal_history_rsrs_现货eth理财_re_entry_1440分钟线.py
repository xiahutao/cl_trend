...
if __name__ == '__main__':
    ...
    period_k1_lst = [i for i in range(8, 9, 1)]  # N1 计算线性回归的K值
    period_std1_lst = [i for i in range(10, 11, 1)]  # N2 计算斜率标准化的周期
    N_l_lst = [i/10 for i in range(18, 19)]  # 多头开仓阈值
    ...
    lever = 1
    fee = 0.0036
    date_lst = [('2017-01-01', '2018-01-01'), ('2018-01-01', '2018-07-01'), ('2018-07-01', '2019-05-02')]
