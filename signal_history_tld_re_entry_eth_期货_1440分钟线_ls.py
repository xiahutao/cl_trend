...
if __name__ == '__main__':
    ...
    P_ATR_LST = [34, 30, 26, 22, 18, 14, 10, 38, 42]  # ATR周期
    ATR_n_lst = [1000000, 0.5, 0.6, 0.7, 0.8, 0.9, 1.0, 1.1, 1.2, 1.3, 1.4, 1.5]  # ATR倍数
    # status_days_lst = [0]
    status_days_lst = [0]
    win_stop_lst = [10]
    ...
    fee = 0.002
    date_lst = [('2017-01-01', '2018-01-01'), ('2018-01-01', '2018-07-01'),
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_tld_entry_eth' + str(n) + 'ls.csv')
