...
if __name__ == '__main__':
    ...
    N1_lst = [i for i in range(10, 11, 1)]  # 短周期
    N2_lst = [i for i in range(52, 53, 2)]  # 中周期
    N3_lst = [i for i in range(135, 136, 5)]  # 长周期
    P_ATR_LST = [20]  # ATR周期
                                                ...
                                                for idx, _row in group_.iterrows():
                                                    ...
                                                    if pos == 0:
                                                        if (status >= 0) & (status < status_day):
                                                            ...
                                                            if _row.high >= max(_row.ma1, (_row.ma2 * N1 * (N2 - 1) -
                                                                                           _row.ma1 * N2 * (N1 - 1)) / (
                                                                                                  N2 - N1),
                                                                                (_row.ma3 * N2 * (
                                                                                        N3 - 1) - _row.ma2 * N3 * (
                                                            ...
                                                            elif _row.low <= min(_row.ma1, (_row.ma2 * N1 * (N2 - 1) -
                                                                                            _row.ma1 * N2 * (
                                                                                                    N1 - 1)) / (
                                                                                                   N2 - N1),
                                                                                 (_row.ma3 * N2 * (
                                                        ...
                                                        if pos == 1:
                                                            if _row.low < (_row.ma2 * N1 * (N2 - 1) - _row.ma1 * N2 * (
                                                                    N1 - 1)) / (N2 - N1):
                                                                s_price = (_row.ma2 * N1 * (N2 - 1) - _row.ma1 * N2 * (
                                                                            N1 - 1)) / (N2 - N1) * (1 - fee)
                                                            ...
                                                            if _row.high >= (
                                                                    _row.ma2 * N1 * (N2 - 1) - _row.ma1 * N2 * (
                                                                    N1 - 1)) / (N2 - N1):
                                                                b_price = (_row.ma2 * N1 * (N2 - 1) - _row.ma1 * N2 * (
                                                                            N1 - 1)) / (N2 - N1) * (1 + fee)
                                                                if _row.open > b_price / (1 + fee):
                                                                ...
                                                                hold_price.append(_row.close)
                                                                net = net * ((
                                                                                         _row.close_1 - _row.close) / _row.close_1 + 1)
                                                    net_lst.append(net)
                                                    pos_lst.append(pos)
    ...
    signal_state = pd.DataFrame(state_lst, columns=['symble', 'tm', 'win_r', 'odds', 'total_ret', 'ann_ret', 'sharp',
                                                    ...
                                                    'road_period_s', 'ma_period', 'win_stop', 'status_day', 's_time',
                                                    'e_time'])
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_crow_entry' + str(n) + 'ls.csv')
