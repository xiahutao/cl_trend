...
if __name__ == '__main__':
    ...
    N1_lst = [i/100 for i in range(52, 58, 1)]  # 下阈值
    N2_lst = [i/100 for i in range(142, 150, 1)]  # 上阈值
    N_lst = [i for i in range(135, 145, 1)]
...
res.to_csv('cl_trend/data/neu_strategy_factor47_' + str(n) + '.csv')
