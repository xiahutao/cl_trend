...
if __name__ == '__main__':
    ...
    N1_lst = [i/100 for i in range(94, 100, 1)]  # 下阈值
    N2_lst = [i/100 for i in range(120, 130, 1)]  # 上阈值
    N_lst = [i for i in range(20, 37, 1)]
...
res.to_csv('cl_trend/data/neu_strategy_factor46_' + str(n) + '.csv')
