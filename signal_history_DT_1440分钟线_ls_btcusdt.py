...
if __name__ == '__main__':
    ...
    P_ATR_LST = [12, 10, 14, 16, 18, 20]  # ATR周期
    ATR_n_lst = [0.6, 0.5, 0.7, 0.8]  # ATR倍数

    lever = 1  # 杠杆率，btc初始仓位pos=1,usdt初始仓位pos=0;做多情况下，btc仓位1+lever,usdt仓位-lever;
    # 做空情况下，btc仓位1-lever,usdt仓位lever
    fee = 0.001
    date_lst = [('2017-01-01', '2018-12-01'), ('2017-01-01', '2017-10-01'), ('2017-10-01', '2018-01-01'), ('2018-01-01', '2018-11-01')]
                                ...
                                for N1 in N1_lst:
                                    if len(group):
                                        ...
                                        if len(day_atr) > road_period:
                                            net = 1
                                            net_lst = []
                                            group_ = day_atr.assign(HH=lambda df: tb.MAX(df.high.values, road_period)) \
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_dt_' + str(n) + 'ls.csv')
