...
if __name__ == '__main__':
    ...
    period_k_lst = [20, 25, 30, 35, 40]  # N1 计算线性回归的K值
    period_std_lst = [50, 55, 60, 65, 70]  # N2 计算斜率标准化的周期
    N_l_lst = [0.8, 0.9, 1.0, 1.1, 1.2]  # 多头开仓阈值
    N_s_lst = [-1.0]  # 空头开仓阈值
    method_lst = [2]
    ...
    print(signal_state)
    signal_state.to_csv('cl_trend/data/state_rsrs_' + str(n) + 'l.csv')
