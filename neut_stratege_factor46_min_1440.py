...
if __name__ == '__main__':
    ...
    N1_lst = [i / 100 for i in range(96, 97, 1)]  # 下阈值
    N2_lst = [i / 100 for i in range(121, 122, 1)]  # 上阈值
    N_lst = [i for i in range(31, 32)]
    loss_stop_list = [1]
                ...
                for N2 in N2_lst:
                    ...
                    signal_state_all = pd.DataFrame(
                        signal_lst, columns=['s_time', 'e_time', 'cont_btc', 'cont_eth', 'k_price_btc',
                                             ...
                                             'position'])
                    signal_state_all.to_csv('cl_trend/data/signal_319_' + str(n) + '.csv')
                    for (s_date, e_date) in date_lst:
                        ...
                        # net_df.to_csv('cl_trend/data/data/319_' + period + '.csv')
