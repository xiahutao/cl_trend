...
if __name__ == '__main__':
            ...
            for N5 in N5_lst:
                ...
                for N3 in N3_lst:
                    for N6 in N6_lst:
                        ...
                        # group_.to_csv('cl_trend/data/309_' + str(n) + '.csv')
                        for N1 in N1_lst:
                            for N4 in N4_lst:
                                        ...
                                        for status_day in status_days_lst:
                                            ...
                                            signal_state_all = pd.DataFrame(
                                                signal_lst, columns=['s_time', 'e_time', 'cont_btc', 'cont_eth', 'k_price_btc',
                                                                     ...
                                                                     'position'])
                                            # signal_state_all.to_csv('cl_trend/data/signal_309_' + str(n) + '.csv')
                                            for (s_date, e_date) in date_lst:
                                                ...
                                                net_df.to_csv('cl_trend/data/data/309_' + period + '.csv')
    ...
    res.to_csv('cl_trend/data/neu_strategy_gzw_' + str(n) + '1.csv')
